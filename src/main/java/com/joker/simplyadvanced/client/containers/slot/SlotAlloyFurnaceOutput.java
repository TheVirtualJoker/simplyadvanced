...
public class SlotAlloyFurnaceOutput extends Slot {
    ...
    public SlotAlloyFurnaceOutput(EntityPlayer player, IInventory inventoryIn, int index, int xPosition, int yPosition) {
    ...
    protected void onCrafting(ItemStack stack) {
        ...
        if (!this.player.world.isRemote) {
            ...
            float f = AlloyFurnaceRecipes.instance().getAlloyExperience(stack);
